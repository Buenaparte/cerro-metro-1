    ...
    return(
        ...
        <div className="container mx-auto w-xl transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-100 hover:shadow position:relative">
            ...
            <div className='text-right' >
                <button className="Saber-mas mb-3 mr-3 bg-orange-500 hover:bg-orange-700 active:bg-orange-900 font-bold shadow-xl rounded-xl w-35 h-12 text-amber-50 
                    transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 position:relative" 
                    onClick={navigation("/item/"+Ruta.id)}>Saber Más
                </button>
            </div>
        </article>
        </div>
